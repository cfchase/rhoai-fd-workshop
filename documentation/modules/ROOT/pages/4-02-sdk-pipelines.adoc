...
If you'd like to browse the code to generate, you can find it in the `pipeline` directory in you `rhods-fd-notebooks` project you are using in your notebook.  Feel free to peruse the code.
...
++++
<a href="https://github.com/cfchase/rhods-fd-notebooks/raw/main/7_get_data_train_upload.yaml" download>https://github.com/cfchase/rhods-fd-notebooks/raw/main/7_get_data_train_upload.yaml</a>
++++


// link:https://github.com/cfchase/rhods-fd-notebooks/raw/main/7_get_data_train_upload.yaml[Download Pipeline YAML, window=_blank, download]
