...
* Enter the git *https* URL, `https://github.com/cfchase/rhods-fd-notebooks.git`, then click *CLONE*:

[.lines_space]
[.console-input]
[source,text]
----
https://github.com/cfchase/rhods-fd-notebooks.git
----

image::workbenches/jupyter-git-modal.png[Git Modal]

* Double-click and navigate to the newly-created folder, `rhods-fd-notebooks`:
...
image::workbenches/jupyter-file-browser-2.png[Jupyter File Browser - rhods-fd-notebooks]
